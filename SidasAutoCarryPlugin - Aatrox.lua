...
--Menu--
AutoCarry.PluginMenu:addParam("Combo", "Auto Win", SCRIPT_PARAM_ONKEYDOWN, false, string.byte(" "))
AutoCarry.PluginMenu:addParam("ComboMix", "Auto Win", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("C"))
