...
function PluginOnLoad()
  ...
  AutoCarry.PluginMenu:addParam("harass", "Harass in Mixed mode", SCRIPT_PARAM_ONOFF, false)
  ...
  AutoCarry.PluginMenu:addParam("torment", "Auto Harras with Torment", SCRIPT_PARAM_ONKEYTOGGLE, false, string.byte("N"))
 ...
 function PluginOnTick()
  ...
  if ultactive == true and GetDistance(target) > 1000 then
    CastSpell(_R)
  end
end
